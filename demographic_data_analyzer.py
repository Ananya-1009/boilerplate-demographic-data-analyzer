...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round((higher_education & (df['salary']=='>50K')).sum()*100/higher_education.sum(),1)
    lower_education_rich =  round((lower_education & (df['salary']=='>50K')).sum()*100/lower_education.sum(),1)
    ...
    rich_percentage = round(((num_min_workers & (df['salary']=='>50K'))).sum()*100/num_min_workers.sum(),1)
